...
const Home = () => {
  let aboutMe =
    "My name is João Victor and I am a 20-year-old software engineer. In my free time, I enjoy to play Valorant and working on personal projects. I am excited to share my skills and experience with others in the field.";
  ...
  return (
    <main className="flex flex-col sm:flex-row gap-8 p-6">
      ...
      <div className="flex flex-col gap-14">
        <TextSection title="Hey, there! 👋" text={aboutMe} size="text-xl" />
        <TextSection
          title="Main Skills 🐱‍👤"
          text={<Skills />}
          size="text-xl"
        ...
        <ul className="flex flex-col gap-6">
          ...
          <p>
            ...
            <a
              href="https://github.com/joaovictornovais"
              className="underline"
              target="__blank"
            >
              GitHub
